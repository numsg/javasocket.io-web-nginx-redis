package com.gsafety.pivs.notice.backend.aspectj;

import com.gsafety.pivs.notice.common.annotation.LimitIPRequestAnnotation;
import com.gsafety.pivs.notice.common.exception.HttpRestException;
...
public class LimitIPRequestAspect {
     ...
     */
    @Before("execution(* com.gsafety.pivs.notice.controller.*.*(..)) && @annotation(com.gsafety.pivs.notice.common.annotation.LimitIPRequestAnnotation)")
